...
import { showCardPagination } from "./showCardsPagination.js";
...
function showModalPagination(name) {
  ...
  <div class="modal__wrapper">
    <div class="modal__card">
      <div class="modal__closeBtn btn-round">
        <img src="${LINKS_IMG.pets}icons/closed.svg" alt="closedModal">
      </div>
      <img src="${LINKS_IMG.pets + currentItem.imgMod}" alt="${
    currentItem.alt
